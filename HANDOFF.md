...
| `apps/ios` | Capacitor wrapper around the deployed PWA | WKWebView points at `red-moss-…azurestaticapps.net`. Xcode project is gitignored — regenerated by CI on every build. See `apps/ios/README.md` for AltStore + TestFlight flows. |
