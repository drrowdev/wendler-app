...
//
// MIRROR of packages/domain/src/agents/coach/response.ts. Kept local because
// Azure Functions on Node16 module resolution can't consume the extensionless
// ESM imports in @wendler/domain.
//
// KEEP IN LOCKSTEP. Any change to the validator schema in domain must be
// mirrored here.
