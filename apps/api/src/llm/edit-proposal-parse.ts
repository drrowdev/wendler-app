// edit-proposal-parse.ts — kept local because Azure Functions on Node16
// module resolution can't follow extensionless ESM imports in @wendler/domain.
// MIRROR of packages/domain/src/agents/chat/edit-proposal-parse.ts. KEEP IN LOCKSTEP.
